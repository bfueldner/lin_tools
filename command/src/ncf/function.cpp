...
#include <lin/ncf/validate/base.hpp>
#include <lin/ncf/validate/diagnostic.hpp>
#include <lin/ncf/validate/encoding.hpp>
#include <lin/ncf/validate/frame.hpp>
#include <lin/ncf/validate/frames.hpp>
#include <lin/ncf/validate/global.hpp>
...
bool validate(node_capability_file_t &node_capability_file, bool verbose)
{
    common::validate::logger_t logger{ verbose };
