...
TEST(test_lin_ldf_node_parser, participating_nodes_master)
{
...
TEST(test_lin_ldf_node_parser, participating_nodes_slaves)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_node_parser, participating_nodes)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_node_parser, node_attribute_lin_protocol)
{
    namespace x3 = boost::spirit::x3;
