...
TEST(test_lin_ldf_signal_parser, standard_signal_init_value_scalar)
{
...
TEST(test_lin_ldf_signal_parser, standard_signal_init_value_array)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_signal_parser, signal_group_group_entry)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_signal_parser, signal_encoding_type)
{
    namespace x3 = boost::spirit::x3;
