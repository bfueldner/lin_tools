...
TEST(test_lin_ldf_frame_parser, unconditional_frame_frame_entry)
{
...
TEST(test_lin_ldf_frame_parser, unconditional_frame)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_frame_parser, unconditional_frames)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_frame_parser, sporadic_frame)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_frame_parser, sporadic_frames)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_frame_parser, event_triggered_frames)
{
    namespace x3 = boost::spirit::x3;
...
TEST(test_lin_ldf_frame_parser, diagnostic_frame)
{
    namespace x3 = boost::spirit::x3;
...
// NOLINTBEGIN(readability-function-cognitive-complexity)
TEST(test_lin_ldf_frame_parser, diagnostic_frames)
{
    namespace x3 = boost::spirit::x3;
