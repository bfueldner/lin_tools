...
#include <lin/type_io/ldf/schedule_table.hpp>

/* 9.2.5 Schedule table defiontion*/

TEST(test_lin_type_io_ldf_schedule_table, frame_name)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_master_req)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_slave_resp)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_assign_nad)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_conditional_change_nad)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_data_dump)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_save_configuration)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_assign_frame_id_range)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_free_format)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, command_assign_frame_id)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, table_entry_assign_nad)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, table_entry_identifier)
{
    using namespace lin::type::ldf::schedule_table;
...
TEST(test_lin_type_io_ldf_schedule_table, schedule_table)
{
    using namespace lin::type::ldf;
...
TEST(test_lin_type_io_ldf_schedule_table, schedule_tables)
{
    using namespace lin::type::ldf;
