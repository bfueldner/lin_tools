...
TEST(test_lin_type_io_ldf_frame, unconditional_frame_frame_entry)
{
    using namespace lin::type::ldf::frame::unconditional_frame;
...
TEST(test_lin_type_io_ldf_frame, unconditional_frame)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, unconditional_frames)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, sporadic_frame)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, sporadic_frames)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, event_triggered_frame)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, event_triggered_frames)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, diagnostic_frame)
{
    using namespace lin::type::ldf::frame;
...
TEST(test_lin_type_io_ldf_frame, diagnostic_frames)
{
    using namespace lin::type::ldf::frame;
