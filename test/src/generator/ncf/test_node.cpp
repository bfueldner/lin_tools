...
TEST(test_lin_ncf_node_generator, node)
{
    ...
    node_t const node{
        ...
        { "2.2",
          ...
          0x20,
          1,
          general::bitrate_definition::automatic_t{ general::bitrate_t{ 10 },
                                                    general::bitrate_t{ 20 } },
          true },
        ...
        { { "position", { signal_encoding_type::physical_range_t{ 0, 199, 1.8, 0.0, "deg" } } },
          { "fault_enc",
            { signal_encoding_type::logical_value_t{ 0, "no result" },
              signal_encoding_type::logical_value_t{ 1, "failed" },
              signal_encoding_type::logical_value_t{ 2, "passed" } } } },
