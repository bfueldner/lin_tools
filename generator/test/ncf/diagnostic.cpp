...
TEST(test_lin_ncf_diagnostic_generator, diagnostic_range)
{
...
TEST(test_lin_ncf_diagnostic_generator, diagnostic_sequence)
{
    using namespace lin::ncf;

    diagnostic_t const diagnostic{
        diagnostic::nad::sequence_t{ 1, 2, 3 }, 2, 100, 40, {}, {}, { 0xB0, 0xB2, 0xB7 }, 127
    };
